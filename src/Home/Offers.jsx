    ...
    <div className="relative w-full bg-white">
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
          ...
          Quality meets convenience - your satisfaction, our priority
          </h1>
          <p className="mt-8 text-lg text-gray-700">
          Subscribe & Save: Access Limited-Time Deals Straight to Your Inbox!
          </p>
        ...
        <div className="relative lg:col-span-5 lg:-mr-8 xl:col-span-6">
          <img
            ...
            src="https://plus.unsplash.com/premium_photo-1661906789703-a25a1e53180e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjR8fHRydXN0fGVufDB8fDB8fHww"
            alt="customer"
          />
        </div>
      </div>
